public class EconomyClassList {
    public Node first;

    // The Constructor Methods
    public EconomyClassList(){ first = null; }
    ...
    public void display_economy_class_passengers(){
        if (is_empty()){ System.out.println("There are no passengers in EconomyClass, please check again later."); }
        else{
            System.out.println("Economy class passengers will be listed below: ");
            Node current = first;
            int index = 1;
            while (current != null){
