public class FirstClassList {
    ...
    public FirstClassList(){ first = null; }
    ...
    public void display_first_class_passengers(){
        if (is_empty()){ System.out.println("There are no passengers in FirstClass, please check again later."); }
        else{
            System.out.println("First class passengers will be listed below: ");
            Node current = first;
            int index = 1;
            while (current != null){
